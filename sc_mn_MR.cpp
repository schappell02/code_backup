...
double min_mass = 3.0 * msun; //in grams
double max_mass = 5.0 * msun;
double min_dist = 7000.0; //in pc
double max_dist = 9000.0;
...
double max_X,max_Y,min_X,min_Y,innerCut,outerCut,ZprimeM,Rcut,Xprime,Yprime;
